            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form method="POST" action="<?php echo base_url('home/daftarsimpan')?>" data-parsley-validate class="form-horizontal form-label-left">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="namalengkap">Nama Lowongan <span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="namalowongan" required="required" class="form-control col-md-7 col-xs-12" name="namalowongan">
                        </div>
                      </div>
                      <div class="form-group">
